            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                <div className={`relative h-32 transition-colors ${tapestry.imagePath ? 'bg-gradient-to-br from-purple-900/50 to-slate-900/50' : 'bg-gradient-to-br from-purple-900/30 to-slate-900'}`}>
                    ...
                    <div className="absolute top-2 right-2">
                        ...
                        {/* Dropdown Menu */}
                        {showMenu && (
                            <div className="absolute right-0 mt-1 w-40 bg-slate-800 border border-slate-700 rounded-md shadow-xl z-20">
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        onEdit(tapestry.id);
                ...
                >
                    ...
                    {tapestry.description && (
                        <p className="text-sm text-slate-300 mb-3 line-clamp-2 shadow-black drop-shadow-sm">
                            {tapestry.description}
                        </p>
                    )}
