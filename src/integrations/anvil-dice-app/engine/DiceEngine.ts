...
export class DiceEngine {
     ...
     */
    public async roll(notation: string, options?: { meta?: any }): Promise<RollResult> {
        ...
        return new Promise((resolve) => {
            ...
            this.emit('rollStart', { notation, options });

            // Core engine doesn't support options, so we handle it at this wrapper level
