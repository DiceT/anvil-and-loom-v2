import { E as EditorView, l as EditorSelection, a as LanguageSupport, L as LRLanguage, p as parseMixed, e as syntaxTree, s as styleTags, i as indentNodeProp, f as foldNodeProp, g as delimitedIndent, t as tags } from "./index-DjLshaWJ.js";
import { html } from "./index-A0vc5EaJ.js";
import { L as LRParser, E as ExternalTokenizer, a as LocalTokenGroup } from "./index-CgPh8PfN.js";
import "./index-1lCvhWgz.js";
import "./index-CfeBgmV7.js";
...
const Filters = /* @__PURE__ */ completions("abs attr batch capitalize center default dictsort escape filesizeformat first float forceescape format groupby indent int items join last length list lower map max min pprint random reject rejectattr replace reverse round safe select selectattr slice sort string striptags sum title tojson trim truncate unique upper urlencode urlize wordcount wordwrap xmlattr", "function");
const Functions = /* @__PURE__ */ completions("boolean callable defined divisibleby eq escaped even filter float ge gt in integer iterable le lower lt mapping ne none number odd sameas sequence string test undefined upper range lipsum dict joiner namespace", "function");
...
const Tags = /* @__PURE__ */ completions("raw endraw filter endfilter trans pluralize endtrans with endwith autoescape endautoescape if elif else endif for endfor call endcall block endblock set endset macro endmacro import include break continue debug do extends", "keyword");
