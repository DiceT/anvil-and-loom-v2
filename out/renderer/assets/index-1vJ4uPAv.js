...
const Diamond = createLucideIcon("diamond", __iconNode$j);
const __iconNode$i = [
...
const Dices = createLucideIcon("dices", __iconNode$i);
const __iconNode$h = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
  ["path", { d: "M12 2a7 7 0 1 0 10 10", key: "1yuj32" }]
];
const Eclipse = createLucideIcon("eclipse", __iconNode$h);
const __iconNode$g = [
...
const Hexagon = createLucideIcon("hexagon", __iconNode$e);
const __iconNode$d = [
...
const Pentagon = createLucideIcon("pentagon", __iconNode$a);
const __iconNode$9 = [
  ["line", { x1: "19", x2: "5", y1: "5", y2: "19", key: "1x9vlm" }],
  ["circle", { cx: "6.5", cy: "6.5", r: "2.5", key: "4mh3h7" }],
  ["circle", { cx: "17.5", cy: "17.5", r: "2.5", key: "1mdrzq" }]
];
const Percent = createLucideIcon("percent", __iconNode$9);
const __iconNode$8 = [
...
const TentTree = createLucideIcon("tent-tree", __iconNode$3);
const __iconNode$2 = [
...
function LeftLane() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-900 border-r border-slate-800 p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-slate-400 mb-3", children: "Tapestry" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-slate-500 text-sm", children: "File tree coming soon..." })
  ] });
}
const useTabStore$1 = create((set, get) => ({
  tabs: [],
  activeTabId: null,
  openTab: (tab) => {
    const { tabs } = get();
...
function recalculateRanges$1(rows, maxRoll) {
...
const useWeaveStore$1 = create((set, get) => ({
  registry: null,
  activeWeaveId: null,
  isLoading: false,
  error: null,
...
function WeaveEditor({ weaveId }) {
  const { registry: weaveRegistry, updateWeave, saveWeave } = useWeaveStore$1();
  const { registry: tableRegistry } = useTableStore();
  const updateTabTitle = useTabStore$1((state) => state.updateTabTitle);
  ...
  const handleMaxRollChange = (maxRoll) => {
    const updated = {
      ...localWeave,
      maxRoll,
      rows: recalculateRanges$1(localWeave.rows, maxRoll)
    };
    setLocalWeave(updated);
  };
  ...
  const handleAddRow = () => {
    ...
    const updatedRows = recalculateRanges$1([...localWeave.rows, newRow], localWeave.maxRoll);
    setLocalWeave({ ...localWeave, rows: updatedRows });
  };
  const handleRemoveRow = (rowId) => {
    const updatedRows = localWeave.rows.filter((row) => row.id !== rowId);
    const recalculated = recalculateRanges$1(updatedRows, localWeave.maxRoll);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full border-collapse", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: localWeave.rows.map((row, index) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-slate-800 hover:bg-slate-850", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-sm text-slate-400", children: row.from }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 text-sm text-slate-400", children: row.to }),
...
function CenterLane() {
  const { tabs, activeTabId, setActiveTab, closeTab } = useTabStore$1();
...
function ResultCard({ card, defaultExpanded = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800 border border-slate-700 rounded-lg overflow-hidden flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-3 border-t border-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `font-bold text-slate-100 ${card.source === "dice" ? "text-2xl" : "text-base"}`, children: card.result }) })
  ] });
}
...
function formatTableRollCard(roll, category, parentName) {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 px-3 hover:bg-slate-800 transition-colors", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Infinity$1, { className: "w-4 h-4 text-slate-500" })
          }
        )
      ] }),
...
function WeaveTool() {
  const { registry, loadWeaves, createWeave, deleteWeave } = useWeaveStore$1();
  const openTab = useTabStore$1((state) => state.openTab);
...
function RightLane() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-900 border-l border-slate-800 h-full", children: renderContent() });
}
...
function AppLayout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TopBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-64 flex-shrink-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LeftLane, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CenterLane, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-80 flex-shrink-0 overflow-visible flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-y-auto app-scroll", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RightLane, {}) }),
